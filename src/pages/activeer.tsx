...
const AutoCompleteOptionAny: any = AutoComplete.Option;
    ...
    render() {
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                <h2>
                    <span style={{ color: 'red' }}>*</span> Hoe heb je ons gevonden?
                </h2>
                <Form.Item>
                    {getFieldDecorator('verwijzing', {
                        rules: [
                            {
                                required: true,
                                message: 'Laat alsjeblieft weten hoe je ons hebt gevonden.'
                            }
                        ]
                    })(
                        <Select>
                            <Option value="school-folder">
                                Ik heb een folder gekregen van mijn basisschool
                            </Option>
                            <Option value="school-leraar">
                                Mijn leraar heeft verteld over de experience
                            </Option>
...
(basisscholen as any)
    .filter(basisschool => basisschool.distance < 15)
    .forEach(basisschool => {
            ...
            <Row>
                <Col span={12} offset={6}>
                    <Stepper>
                        ...
                        >
                            <h2>
                                <span style={{ color: 'red' }}>*</span> Selecteer je bassischool
                            </h2>
                            <AutoCompleteAny
                                style={{ width: '400px' }}
                                dataSource={Object.keys(scholenOpties).map(plaats => (
                                    <AutoComplete.OptGroup label={plaats}>
                                        {scholenOpties[plaats].map(basisschool => (
                                            <AutoCompleteOptionAny
                                                value={basisschool.id}
                                                naam={basisschool.naam}
                                            >
                                                {basisschool.naam}
                                            </AutoCompleteOptionAny>
                                        ))}
                            ...
                            <Checkbox
                                onChange={e =>
                                    e.target.checked
                                        ? setFormData({ ...formData, school: '000000' })
                                        : setFormData({ ...formData, school: undefined })
                                }
                            >
                                Mijn school staat hier niet bij
                            </Checkbox>
                            <br />
                            <br />
